...
def run_ranking(
...
) -> tuple[RankingResult, dict[str, Path], dict[str, Any], dict[str, Any]]:
    ...
    return result, output_paths, validation, jd_profile
...
def main(argv: list[str] | None = None) -> int:
    ...
    profile_requested = args.profile_only or args.profile_and_rank or not args.rank
    ...
    if rank_requested:
        ...
        if not fingerprints_path.exists():
            ...
            return 2
        result, output_paths, validation, jd_profile = run_ranking(
            fingerprints_path,
